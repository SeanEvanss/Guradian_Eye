            ...
            mService.getPath(requestApi)
                    .enqueue(new Callback<String>() {
                        ...
                        public void onFailure(Call<String> call, Throwable t) {
                            Toast.makeText(DriveActivity.this,""+t.getMessage(),Toast.LENGTH_SHORT).show();
                        }
                    });
        }catch (Exception e){
            e.printStackTrace();
    ...
    private void displayLocation() {
        ...
        if (mLastLocation!=null) {
            if (location_switch.isChecked()) {
                ...
                geoFire.setLocation(FirebaseAuth.getInstance().getCurrentUser().getUid(), new GeoLocation(latitude, longitude), (key, error) -> {
                    if (mCurrent!=null)
                        mCurrent.remove();
